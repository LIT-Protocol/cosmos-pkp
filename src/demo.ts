...
// keplr wallet data
const keplrMnemonicString =
  "either control crazy lonely police foam swim replace salute snap quick harbor";
const keplrAddress = "cosmos16a6zyjwyww6scfa44s9jekdwwjfjrpppajk9d0";
const keplrPubKey = new Uint8Array([
  2, 246, 84, 18, 18, 44, 210, 108, 254, 182, 178, 122, 254, 228, 57, 254, 89,
  134, 104, 35, 144, 69, 137, 41, 155, 100, 240, 40, 193, 126, 48, 195, 130,
]);

// pkp owner wallet data
const pkpOwnerPubKey =
  "0x04507302fc8404fe81260ed233a2d79f209f6789948b4fb31811fe9099bd0459ec8d7c893d10b65c8dd72a296084e8729dfeb13265c3d33d6b6fd6bad92616efad";
const pkpOwnerCompressedPubKey =
  "0x03507302fc8404fe81260ed233a2d79f209f6789948b4fb31811fe9099bd0459ec";
...
const pkpOwnerAuthSig = {
  ...
  signedMessage:
    "lit-swap-playground.netlify.app wants you to sign in with your Ethereum account:\n0x20623933681a53D5ee48959eC1770BeA7afA4eDe\n\n\nURI: https://lit-swap-playground.netlify.app/\nVersion: 1\nChain ID: 137\nNonce: jPKR8TYXLgYKFNE4d\nIssued At: 2023-03-08T17:15:06.230Z\nExpiration Time: 2023-03-15T17:15:06.207Z",
  address: "0x20623933681a53D5ee48959eC1770BeA7afA4eDe",
};

// pkp data
const pkpPublicKey =
  "0x0460579cb0d4bb4846ba43a001e7ec6c42e4db62f3b9c40358df31392e90b24952217c60c945c434dfb68bfc1e5b7cd89b41d1180bdd12b76a9f1d2f82b6d0d6db";
const pkpCompressedPublicKey =
  "0x0360579cb0d4bb4846ba43a001e7ec6c42e4db62f3b9c40358df31392e90b24952";
