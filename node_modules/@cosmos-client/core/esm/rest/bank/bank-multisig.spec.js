...
describe('bank', () => {
    it('send', async () => {
        ...
        const signature = txBuilder.createSignatureOfMultisig([privKey1.sign(signDocBytes), null, privKey3.sign(signDocBytes)], authInfo.signer_infos[0].mode_info?.multi);
